      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-4 border-b border-slate-200/80">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-white text-xs font-semibold flex items-center gap-1.5 shadow-xs transition-all cursor-pointer active:scale-95 ${frozen
          ...
          <div className="flex items-center bg-slate-100 p-0.5 rounded-xl border border-slate-200/80 text-xs">
            {['ALL', 'CIRCULAR', 'REGULAR'].map((filter) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg transition-all font-medium cursor-pointer ${filterType === filter
